...
const PropertyDetails = () => {
  ...
  return (
    <section>
      <div className='container mx-auto min-h-[800px] bottom-14'>
          ...
          <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
            <div className='flex items-center gap-x-4 mb-8'>
              ...
              <div>
                ...
                <Link to='' className='text-sm text-violet-700'>View Listing</Link>
              </div>
            </div>
            {/* {form} */}
            <form className='flex flex-col gap-y-4'>
              ...
              <div className='flex gap-x-2'>
                <button className='bg-violet-700 hover:bg-violet-800 transition rounded p-4 text-sm w-full text-white'>Send Message</button>
